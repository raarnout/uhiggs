...
export const ButtonSizes: Story = {
  render: () => (
    <div style={{
      ...
      <Button size="lg" className="m-2">Large</Button>
    </div>
  ),
  parameters: {
...
export const OutlineButtons: Story = {
  render: () => (
    ...
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
      ...
      <Button variant="warning" outline={true}>Warning</Button>
      <Button variant="info" outline={true}>Info</Button>
      <Button variant="light" outline={true}>Light</Button>
...
export const PillButtons: Story = {
  render: () => (
    ...
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
      ...
      <Button variant="danger" pill={true}>Danger</Button>
      <Button variant="warning" pill={true}>Warning</Button>
      <Button variant="info" pill={true}>Info</Button>
      <Button variant="light" pill={true}>Light</Button>
...
export const SquareButtons: Story = {
  render: () => (
    ...
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
      ...
      <Button variant="danger" square={true}>Danger</Button>
      <Button variant="warning" square={true}>Warning</Button>
      <Button variant="info" square={true}>Info</Button>
      <Button variant="light" square={true}>Light</Button>
...
export const ShadowedButtons: Story = {
  render: () => (
    ...
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
      ...
      <Button variant="danger" shadow={true}>Danger</Button>
      <Button variant="warning" shadow={true}>Warning</Button>
      <Button variant="info" shadow={true}>Info</Button>
...
export const BlockButtons: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
      <Button variant="primary" block={true}>Primary</Button>
      <Button variant="secondary" block={true}>Secondary</Button>
      <Button variant="success" block={true}>Success</Button>
      <Button variant="danger" block={true}>Danger</Button>
      <Button variant="warning" block={true}>Warning</Button>
      <Button variant="info" block={true}>Info</Button>
      <Button variant="light" block={true}>Light</Button>
      <Button variant="dark" block={true}>Dark</Button>
      <Button variant="link" block={true}>Link</Button>
    </div>
  ),
  parameters: {
    controls: { disable: true }
...
export const buttonIcon: Story = {
  ...
  render: () => (
    <div>
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem'  }}>
      <Button size='sm' iconStart="arrow-left">Left</Button>
      <Button size='sm' iconEnd="arrow-right">Right</Button>
      <Button size='sm' iconStart="arrow-left" iconEnd="arrow-right">Left and Right</Button>
  ...
  <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
      ...
      <Button iconStart="arrow-left" iconEnd="arrow-right">Left and Right</Button>
    ...
    <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap'}}>
      ...
      <Button size='lg' iconStart="arrow-left" iconEnd="arrow-right">Left and Right</Button>
